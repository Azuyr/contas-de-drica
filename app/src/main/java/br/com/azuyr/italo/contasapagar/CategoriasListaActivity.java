...
public class CategoriasListaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        campoPesquisa = findViewById(R.id.categorias_lista_pesquisa);
    ...
    private void carregaLista() {
        ...
        EditText pesquisa = findViewById(R.id.categorias_lista_pesquisa);

        List<ContaVencimento> contas = dao.buscaContasVencimentos(pesquisa.getText().toString());
